...
<ul>
<li><a href="https://nodejs.org/" target="_blank" rel="noopener noreferrer">Node.js v12+<ExternalLinkIcon/></a></li>
<li><a href="https://classic.yarnpkg.com/zh-Hans/" target="_blank" rel="noopener noreferrer">Yarn v1 classic<ExternalLinkIcon/></a> （可选）</li>
</ul>
<div class="custom-container tip"><p class="custom-container-title">TIP</p>
<ul>
<li>使用 <a href="https://pnpm.io/zh/" target="_blank" rel="noopener noreferrer">pnpm<ExternalLinkIcon/></a> 时，你需要在 <a href="https://pnpm.io/zh/npmrc#shamefully-hoist" target="_blank" rel="noopener noreferrer"><code>.npmrc</code><ExternalLinkIcon/></a> 文件中设置 <code>shamefully-hoist=true</code> 。</li>
<li>使用 <a href="https://yarnpkg.com/" target="_blank" rel="noopener noreferrer">yarn 2<ExternalLinkIcon/></a> 时，你需要在 <a href="https://yarnpkg.com/configuration/yarnrc#nodeLinker" target="_blank" rel="noopener noreferrer"><code>.yarnrc.yml</code><ExternalLinkIcon/></a> 文件中设置 <code>nodeLinker: 'node-modules'</code> 。</li>
</ul>
</div>
...
<ul>
<li><strong>步骤4</strong>: 在 <code>package.json</code> 中添加一些 <a href="https://classic.yarnpkg.com/zh-Hans/docs/package-json#toc-scripts" target="_blank" rel="noopener noreferrer">scripts<ExternalLinkIcon/></a></li>
</ul>
...
<p>现在，你应该已经有了一个简单可用的 VuePress 文档网站。接下来，了解一下 VuePress <RouterLink to="/guide/configuration.html">配置</RouterLink> 相关的内容。</p>
</template>
